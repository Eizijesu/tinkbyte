...
<TableBlock 
  caption="Key Technologies Enabling Low-Code Success"
  style="default"
  hasHeaders={true}
  tableData="Technology,Purpose,Business Impact
...
Auto-scaling Infrastructure,Handles traffic spikes automatically,Reduces operational overhead
Built-in Governance,Security and compliance controls,Meets enterprise requirements"
/>
